...
import com.algaworks.algafood.api.v1.openapi.model.LinkModelOpenApi;
...
public class SpringFoxConfig implements WebMvcConfigurer {
	...
	public Docket apiDocketV1() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.globalResponseMessage(RequestMethod.POST, postPutGlobalResponseMessages())
				.globalResponseMessage(RequestMethod.PUT, postPutGlobalResponseMessages())
				.globalResponseMessage(RequestMethod.DELETE, deleteGlobalResponseMessages())
				.additionalModels(typeResolver.resolve(Problem.class))
				.ignoredParameterTypes(ServletWebRequest.class, 
						URL.class, URI.class, URLStreamHandler.class, Resource.class, 
						File.class, InputStream.class)
				.directModelSubstitute(Pageable.class, PageableModelOpenApi.class)
				.directModelSubstitute(Links.class, LinkModelOpenApi.class)
	...
	private List<ResponseMessage> postPutGlobalResponseMessages() {
		return Arrays.asList(
					new ResponseMessageBuilder()
						.code(HttpStatus.INTERNAL_SERVER_ERROR.value())
						.message("Erro interno do servidor")
	...
	private List<ResponseMessage> deleteGlobalResponseMessages() {
		return Arrays.asList(
					new ResponseMessageBuilder()
						.code(HttpStatus.INTERNAL_SERVER_ERROR.value())
						.message("Erro interno do servidor")
	...
	private ApiInfo apiInfoV1() {
		return new ApiInfoBuilder()
				...
				.version("1")
				.contact(new Contact("AlgaWorks", "https://www.algaworks.com", "rhabbiati@hotmail.com"))
				.build();
	}
