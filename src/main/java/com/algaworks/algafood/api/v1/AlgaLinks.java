...
public class AlgaLinks {
	...
	public Link linkToUsuarioGrupoDesassociacao(Long usuarioId, 
	...
	public Link linkToGrupoPermissaoDesassociacao(Long grupoId, 
			Long permissaoId, String rel) {
		return linkTo(methodOn(GrupoPermissaoController.class)
				.associarPermissao(grupoId, permissaoId)).withRel(rel);
	}
	...
	public Link linkToEstatisticasVendasDiarias(String rel) {
		TemplateVariables estatisticasVariables = new TemplateVariables(
					new TemplateVariable("restauranteId", VariableType.REQUEST_PARAM),
					new TemplateVariable("dataCriacaoInicio", VariableType.REQUEST_PARAM),
					new TemplateVariable("dataCriacaoFim", VariableType.REQUEST_PARAM),
		...
		String estatisticasFiltro = linkTo(methodOn(EstatisticasController.class)
				.consultarVendasDiarias(null, null)).withRel(rel).toUri().toString();
		
		return new Link(UriTemplate.of(estatisticasFiltro, estatisticasVariables), rel);
	}
