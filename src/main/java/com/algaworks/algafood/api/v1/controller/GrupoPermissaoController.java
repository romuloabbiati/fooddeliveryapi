...
public class GrupoPermissaoController implements GrupoPermissaoControllerOpenApi{
	...
	public CollectionModel<PermissaoModel> listar(@PathVariable Long grupoId) {
		...
		CollectionModel<PermissaoModel> permissoesCollectionModel = permissaoModelAssembler
				.toCollectionModel(permissoes)
				.removeLinks();
		
		permissoesCollectionModel.add(algaLinks.linkToGrupoPermissoes(grupoId));
		
		if(algaSecurity.podeEditarUsuariosGruposPermissoes()) {
			permissoesCollectionModel.add(algaLinks.linkToGrupoPermissaoAssociacao(grupoId, "associar"));
