...
public class UsuarioGrupoController implements UsuarioGrupoControllerOpenApi {
	...
	public CollectionModel<GrupoModel> listar(@PathVariable Long usuarioId) {
		...
		CollectionModel<GrupoModel> gruposCollectionModel = grupoModelAssembler.toCollectionModel(grupos)
				.removeLinks();
		
		if(algaSecurity.podeEditarUsuariosGruposPermissoes()) {
			gruposCollectionModel.add(algaLinks.linkToUsuarioGrupoAssociacao(usuarioId, "associar"));
			
			gruposCollectionModel.getContent().forEach(grupoModel -> {
